...
plot(muni_join, "munipoint_count", breaks = 10, col = colors1(10), background = "lightblue", 
     main= "Muni Stops in SF Neighborhoods", axes=FALSE, cex.main = 1)
text(x=-122.435, y=37.7072, "ABT 181N Jasper Dong & Tosca Wong", col = "black", cex=0.25)
lines(newv, col="black")
north(xy= "topleft", type=2, cex= 0.8)
sbar(5, xy=c(-122.5,37.829), type="line", divs=2, labels=c(0,500,1000), 
...
********Map description and discussion
...
********Plot description and discussion
